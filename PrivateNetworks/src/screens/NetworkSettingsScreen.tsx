...
const NetworkSettingsScreen: React.FC<Props> = ({navigation, route}) => {
  const {networkName, description, maxMembers} = route.params;
    ...
    try {
      ...
      if (response.success) {
        ...
        const storedNetwork: StoredNetwork = {
          networkId: response.networkId, // Use the ID generated by backend
          name: networkName,
          description,
          ...
          isCreator: true,
          membershipStatus: 'active', // Creator is immediately active
        };
